...
export class YeetCommand extends Command {
        public override async chatInputRun(interaction: CommandInteraction){
			...
			let replymsg = <Message> await interaction.reply({content: 'pinging...', ephemeral:true, fetchReply: true})
				pingEmbed.setAuthor({
					name: `Pong! Latency is ${replymsg.createdTimestamp - interaction.createdTimestamp}`,
				})
